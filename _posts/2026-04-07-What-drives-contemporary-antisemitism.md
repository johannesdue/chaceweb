...
The very brief summary is that patterns of antisemitic hostility do not align with what we would expect if 21st-century antisemitism were primarily driven by a general "syndrome" of outgroup hostility. Instead, the findings strongly suggest that hostile sentiment toward Israel and Zionism serves as the key driving or catalyzing force behind the intensification of antisemitic hostility.

The article---[What Drives Antisemitic Hostility in the Twenty-First Century? A Comparative Case Study of Germany, Sweden, and Russia (1990–2020)](https://link.springer.com/article/10.1007/s12397-026-09723-z)---is published open access and freely available.
